          ...
          <gmd:thesaurusName>
            <gmd:CI_Citation>
              ...
              <gmd:identifier>
                <gmd:MD_Identifier>
                  <gmd:code>
                    <gmx:Anchor xlink:href="http://geocatalogue.hautsdefrance.fr/geonetwork/srv/fre/thesaurus.download?ref=local.theme.themes_sig">geonetwork.thesaurus.local.theme.themes_sig</gmx:Anchor>
                  </gmd:code>
                </gmd:MD_Identifier>
              </gmd:identifier>
            </gmd:CI_Citation>
